      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="hidden md:flex items-center space-x-2">
          <input
            ...
            className="bg-transparent border border-transparent hover:border-white/10 focus:border-indigo-500/50 rounded-lg px-2.5 py-1 text-sm font-medium text-slate-200 focus:outline-none focus:bg-slate-900/50 transition"
